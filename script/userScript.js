...
const displayBasicUserDetails = (user) => {
	...
	username.innerHTML = user.html_url ? `<a href="${user.html_url}" target="_blank">${user.html_url}</a>` : "<i>Not Available</i>";
	...
	if (user.twitter_username) {
		twitter.innerHTML = `Twitter: <a href="https://twitter.com/${user.twitter_username}" target="_blank">https://twitter.com/${user.twitter_username}</a>`;
	}
